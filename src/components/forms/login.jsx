...
export const Login = () => {
  ...
  return (
    <main>
      <Header />
      <div className="w-[1200px] h-[700px] flex mx-auto mt-40">
          ...
          <div className="absolute text-center text-white">
            <h2 className="text-5xl font-bold uppercase">
              ...
              <span className="relative">
                <span className="z-10 relative">maior Plataforma</span>
                <span className="absolute bottom-0 left-0 w-full h-7 bg-orange -z-1"></span>
              </span>{" "}
              de Doacao de Roupas do{" "}
              <span className="relative">
        ...
        <div className="w-1/2 h-full flex flex-col items-center justify-center bg-white border border-sky-blue-100">
          <p className="mt-4 text-center text-2xl font-bold tracking-tight text-verde-100">
            Nwana
          </p>
          <ShoppingBag
            size={22}
